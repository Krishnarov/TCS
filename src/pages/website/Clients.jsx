      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
              Our Valued <span className="text-yellow-500">Partners</span>
            </h2>
            ...
            {clients.map((client, index) => (
              ...
              >
                ...
                <div className="text-center mb-6">
                  ...
                  <p className="text-yellow-600 font-semibold mb-1">{client.industry}</p>
                ...
                <div className="flex justify-between items-center pt-4 border-t border-gray-200">
                  <div className="text-left">
                    <p className="text-yellow-600 font-semibold text-sm">{client.projects}</p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
              Why Clients <span className="text-yellow-500">Trust Us</span>
            </h2>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
              Services for Our <span className="text-yellow-500">Clients</span>
            </h2>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {clientServices.map((service, index) => (
              ...
              >
                <div className="w-12 h-12 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-2xl flex items-center justify-center mx-auto mb-4 text-white">
                  {service.icon}
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">{service.category}</h3>
                <p className="text-yellow-600 font-semibold">{service.count}</p>
              </motion.div>
            ))}
          </div>
        </div>
