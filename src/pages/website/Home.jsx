          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                <div className="flex -space-x-3">
                  {[1, 2, 3].map((item) => (
                    <div key={item} className="w-12 h-12 bg-yellow-500 rounded-full border-2 border-gray-900 flex items-center justify-center text-xs font-bold text-white">
                      {clients[item-1]?.name.substring(0,2)}
                    </div>
                  ))}
                </div>
                <div className="text-gray-300">
                  <p className="font-semibold">Trusted by Industry Leaders</p>
                  <p className="text-sm">SUZLON, GEECO, TEFUGEN & more</p>
                </div>
              </motion.div>
            </motion.div>
            ...
            >
              ...
              <motion.div
                ...
                className="absolute -top-4 -left-4 bg-white rounded-lg shadow-2xl p-4"
              >
              ...
              <motion.div
                ...
                className="absolute -bottom-4 -right-4 bg-white rounded-lg shadow-2xl p-4"
              >
                <div className="flex items-center space-x-3">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="space-y-4">
                ...
                <div className="bg-gray-800 rounded-2xl p-6 h-48 flex flex-col justify-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ y: -10 }}
                className="bg-white rounded-2xl shadow-xl hover:shadow-2xl border border-gray-100 p-8 transition-all duration-300 group cursor-pointer"
              >
                <div className="w-16 h-16 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-2xl flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform duration-300">
                  {service.icon}
                </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
              Why <span className="text-yellow-500">Choose TCS</span>?
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {whyChooseUs.map((item, index) => (
              <motion.div
                ...
                className="bg-white rounded-2xl shadow-lg hover:shadow-xl border border-gray-100 p-8 transition-all duration-300 text-center"
              >
                <div className="w-16 h-16 bg-yellow-500 rounded-2xl flex items-center justify-center mx-auto mb-6 text-white">
                  {item.icon}
                </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {clients.map((client, index) => (
              ...
              >
                <div className="w-20 h-20 bg-yellow-500 rounded-2xl flex items-center justify-center mx-auto mb-6 text-white font-bold text-xl">
