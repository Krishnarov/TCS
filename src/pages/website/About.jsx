          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="mt-8 p-6 bg-yellow-50 rounded-2xl border border-yellow-100"
              >
            ...
            >
              ...
              <motion.div
                ...
                className="absolute -top-4 -left-4 bg-white rounded-xl shadow-2xl p-4"
              >
              ...
              <motion.div
                ...
                className="absolute -bottom-4 -right-4 bg-white rounded-xl shadow-2xl p-4"
              >
                <div className="text-center">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <motion.div
              ...
              className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100"
            >
              <div className="w-16 h-16 bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center mb-6 text-white">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
              Meet Our <span className="text-yellow-500">Director</span>
            </h2>
          </motion.div>
