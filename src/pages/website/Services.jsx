              ...
              >
                ...
                <div className={index % 2 === 1 ? 'lg:col-start-2' : ''}>
                  <motion.div
                    ...
                    className="w-16 h-16 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-2xl flex items-center justify-center text-white mb-6"
                  >
                    {service.icon}
                  </motion.div>
                ...
                <div className={index % 2 === 1 ? 'lg:col-start-1 lg:row-start-1' : ''}>
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      className="absolute -top-4 -right-4 bg-white rounded-xl shadow-2xl p-3"
                    >
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
              Service <span className="text-yellow-500">Benefits</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
