      ...
      <section className="relative py-20 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            >
              Quality <span className="text-yellow-500">Certification</span>
            </motion.h1>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
              Quality <span className="text-yellow-500">Achievements</span>
            </h2>
          </motion.div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
              Quality <span className="text-yellow-500">Certifications</span>
            </h2>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
              Our Quality <span className="text-yellow-500">Standards</span>
            </h2>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
              Industry <span className="text-yellow-500">Compliance</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
        ...
        <div className="container mx-auto px-6">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-bold mb-6">
              Certified <span className="text-yellow-500">Excellence</span>
            </h2>
